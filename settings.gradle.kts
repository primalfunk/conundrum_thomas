...
include(":thomas:personal-data-persistence")
include(":thomas:longitudinal-store")
include(":thomas:language-evidence")
include(":thomas:journal")
include(":thomas:biographer")
include(":thomas:retrieval")
include(":thomas:context-packet")
include(":thomas:therapy-longitudinal")
include(":thomas:language-renderer")
