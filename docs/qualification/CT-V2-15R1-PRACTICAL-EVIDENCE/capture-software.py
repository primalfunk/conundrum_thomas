...
root=Path.cwd()
dest=root/'docs/qualification/CT-V2-15R1-PRACTICAL-EVIDENCE'
...
assert summary['tests']==1004 and summary['suites']==65,summary
...
for suffix in ['CTV215R1PracticalAdjudicationTest','CTV215R1DurableTurnIdentityTest','CTV215R1ReopenIdentityDiagnosticTest','CTV215R1RecurrenceRuntimeTest','CTV215R1RendererRecurrenceTest']:
