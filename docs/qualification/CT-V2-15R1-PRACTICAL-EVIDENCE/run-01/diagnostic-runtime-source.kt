...
class ThomasProductionRuntime(
    ...
    private fun submitTherapy(request: ProductionTurnRequest): ProductionTurnResult {
        ...
        println("PRACTICAL_OBSERVATION requestMode="+request.mode+" requestSupport="+request.requestedTherapySupport+" state="+therapyState)
        ...
        println("PRACTICAL_RENDER_COMMAND="+command)
        val rendered = render(command)
        println("PRACTICAL_RENDER_RESULT="+rendered)
