...
root=Path.cwd()
dest=root/'docs/qualification/CT-V2-15R1-IDENTITY-EVIDENCE'
...
assert summary['tests']==1000 and summary['suites']==64,summary
...
for suffix in ['CTV215R1DurableTurnIdentityTest','CTV215R1ReopenIdentityDiagnosticTest','CTV215R1RecurrenceRuntimeTest','CTV215R1RendererRecurrenceTest']:
...
(dest/'canonical-build.txt').write_text((root/'out/ct-v2-15r1-identity/final-canonical-build.txt').read_text(encoding='utf-16'),encoding='utf-8')
