...
internal class ProtectedPersonalDataStoreImpl(
    ...
    override fun submit(request: LongitudinalAdmissionRequest): AdmissionResult {
        println("R1_DISPATCH t=" + System.nanoTime() + " STORE_ENTER key=" + request.idempotencyKey.value)
        ...
        return try {
            ...
            document = candidate
            println("R1_DISPATCH t=" + System.nanoTime() + " STORE_COMMITTED revision=" + revision)
