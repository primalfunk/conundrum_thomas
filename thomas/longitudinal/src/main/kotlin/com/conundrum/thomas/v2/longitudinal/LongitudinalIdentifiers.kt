...
@JvmInline value class SourceRecordId private constructor(val value: String) : Comparable<SourceRecordId> {
...
@JvmInline value class InteractionId private constructor(val value: String) : Comparable<InteractionId> {
...
@JvmInline value class AssertionId private constructor(val value: String) : Comparable<AssertionId> {
...
@JvmInline value class LifeEntityId private constructor(val value: String) : Comparable<LifeEntityId> {
...
@JvmInline value class PersonalConceptId private constructor(val value: String) : Comparable<PersonalConceptId> {
...
@JvmInline value class HypothesisId private constructor(val value: String) : Comparable<HypothesisId> {
...
@JvmInline value class EvidenceRelationId private constructor(val value: String) : Comparable<EvidenceRelationId> {
...
@JvmInline value class IdentityLinkId private constructor(val value: String) : Comparable<IdentityLinkId> {
...
@JvmInline value class CoverageTopicId private constructor(val value: String) : Comparable<CoverageTopicId> {
